      ...
      <div className="p-4 border-b border-border bg-surface">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
            <kbd className="hidden group-focus-within:none sm:inline-block px-1.5 py-0.5 bg-white border border-slate-200 rounded text-[10px] text-slate-400 font-sans">
              /
            </kbd>
          </div>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 ml-2">
                <span
                  className={`text-sm ${isSelected ? 'font-bold text-slate-900' : 'font-medium text-slate-700'}`}
                >
                  {train.name}
                </span>
                <span
                  className={`text-xs ${isSelected ? 'text-slate-500 font-medium' : 'text-slate-400'}`}
                >
                  {train.taskType}
                </span>
              </div>
